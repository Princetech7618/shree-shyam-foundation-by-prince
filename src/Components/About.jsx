...
// <Hero 
// shlokHindi="ॐ"
// mainTitleHindi="About Us"
// // descriptionHindi="Connecting devotion with seamless experiences, we aim to make every spiritual journey meaningful and memorable."
// imageSrc="temple.jpg"
// />
...
import { Sparkles, Target, Eye, ShieldCheck, Heart } from 'lucide-react';
import Hero from "./Hero";

const members = [
  { name: "Rajkumari", role: "Member", img: "/photo1.png" },
  { name: "Anuradha Sharma", role: "Member", img: "/photo2.png" },
  { name: "Rohit Thakur", role: "Member", img: "/photo3.png" },
  { name: "Sanjay Malik", role: "Member", img: "/photo4.png" },
  { name: "Dr. Devindar sain", role: "Member", img: "/photo5.png" },
  { name: "Neera Malik", role: "Member", img: "/women.png" },
  { name: "Atender kumar", role: "Member", img: "/men.png" },
  { name: "Rupam Jha", role: "Member", img: "/onemore.png" },
];

const boardMembers = [
  { src: "/client1.png", name: "Mukesh Kumar", role: "Director" },
  { src: "/client2.png", name: "Rajesh Kumar", role: "Director" },
  { src: "/client3.png", name: "Reena Gupta", role: "Director" },
  { src: "/client4.png", name: "Vinesh Yadav", role: "Director" },
  { src: "/client5.jpeg", name: "Ram Kumar Jha", role: "Director" },
];
...
const About = () => {
  ...
  return (
    <div className="bg-[#0a0a0a] text-white overflow-hidden">
      ...
      {/* 2. Divine Origin Section (Shree Khatu Shyam Ji) */}
      <section className="relative py-20 lg:py-32 px-6 lg:px-20 bg-gradient-to-b from-[#ffffff] to-[#ffffff]">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          <motion.div 
            initial="hidden" whileInView="visible" variants={fadeInUp} viewport={{ once: true }}
            className="w-full lg:w-1/2 space-y-8"
          >
            <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full border border-red-500/30 bg-red-500/5 text-red-500 text-sm tracking-[0.3em] uppercase">
              <Sparkles size={16} /> Divine Presence
            </div>
            <h1 className="text-3xl md:text-4xl font-semibold leading-tight">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-500">Shree Khatu Shyam Ji</span> 
            </h1>
            <p className="text-gray-900 text-lg leading-relaxed text-justify font-light ">
Certainly! Here's an expanded version: Shree Khatu Shyam Ji, the revered manifestation of Barbarik, the grandson of Bhima, holds a special place in the hearts of millions of devotees, particularly in Rajasthan and Haryana. Known for his unparalleled sacrifice during the Mahabharata, Barbarik was blessed by Lord Krishna, who foretold that in the age of Kaliyuga, he would be worshipped as Shyam. This divine form of worship signifies an unwavering faith in Lord Krishna’s power and grace. It is believed that chanting Shyam Ji’s name with pure devotion can bring miraculous results, alleviating suffering, fulfilling desires, and guiding individuals on the path of spiritual enlightenment. His divine presence is a beacon of hope, offering solace to those in distress and blessing them with peace, protection, and prosperity. Through sincere devotion, Shree Khatu Shyam Ji reminds us of the power of faith, sacrifice, and the eternal blessings of divine grace.
            </p>
          ...
          >
            <div className="absolute -inset-4 bg-red-600/20 blur-[120px] rounded-full"></div>
            <img
              src="https://ksbsf.in/wp-content/uploads/2022/08/khatu-shyam-2.jpg"
              alt="Khatu Shyam Ji"
              className="relative rounded-2xl shadow-2xl border border-white/10 w-full object-cover z-10"
            />
          </motion.div>
        </div>
      </section>

      {/* 3. Significance & Legend Section (Dark Background with Cards) */}
      <section className="py-2 px-6  bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-4">
             <h2 className="text-3xl md:text-5xl font-bold text-red-500">Temple Significance</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <motion.div key={i} whileHover={{ y: -10 }} className="rounded-2xl overflow-hidden shadow-xl border border-gray-100">
                <img src={url} alt="Temple" className="h-72 w-full object-cover" />
              </motion.div>
            ))}
          </div>
             <h2 className="text-center text-3xl md:text-4xl font-bold text-red-500 pb-4">Khatu Shyam Ji Temple Significance
</h2>

          <div className="  text-gray-700 text-lg leading-relaxed text-justify">
            
            <p className='px-4 md:px-10'>The Khatu Shyam Temple, located in Khatu town of Sikar district, Rajasthan, is a prominent Hindu pilgrimage site dedicated to Lord Shyam, believed to be the manifestation of Barbarik, the grandson of Bhima from the Mahabharata. The original temple was constructed in 1027 AD by Roopsingh Chauhan and his wife Narmada Kanwar, and it was later renovated in 1720 AD by Diwan Abhaisingh under the Marwar ruler’s directive. The idol, made of rare stone and worshipped in the form of a head (Shish), is said to have emerged from the holy pond known as Shyam Kund. The temple, built from pristine Makrana marble, is admired for its unique Rajputana architecture, including silver-covered sanctum doors, intricately painted prayer halls, and marble entrance gates with floral carvings. The precincts include Shyam Bagicha, a garden used for floral offerings; the Samadhi of Aloo Singh, a devoted follower; and nearby temples like Gopinath and Gaurishankar—the latter known for a miraculous event where blood reportedly gushed from a Shiva Lingam struck by Mughal soldiers. As the family deity of countless devotees and a symbol of divine grace in the Kaliyuga (the present age of darkness), Lord Shyam is believed to fulfill the wishes of those who worship with a pure heart. The Samadhi of Aloo Singh,(a great devotee), is located within the garden. The Gopinath temple lies to the south- east of the main temple. The Gaurishankar temple also lies nearby. There is an interesting tale associated with the Gaurishankar temple. It is said that some soldiers of the mughal emperor Aurangzeb wanted to destroy this temple. They attacked the Shiva lingam enshrined within this temple with their spears. Immediately, fountains of blood appeared from the Shiva Linga. The soldiers ran away, terrified. One can still see the mark of the spear on the Lingam. Khatu town is situated in the Sikar District, Rajasthan, India. Shyamji’s temple, constructed of the famous Makrana marble, lies in the heart of the town. Lord Shyamji is considered to be the God of the Kaliyug means (the present age where sin and wrong doing is at its maximum.)</p>
                         <h2 className="pb-4 text-center text-3xl md:text-4xl font-bold text-red-500">Barbarika
</h2>

            <p className='px-4 md:px-10'>The legend begins with the Mahābhārata. Barbarika alias ‘Khatu Shyam’ alias Shyam Baba was son of Bhima (Second of the Pandava brothers) and Mata Ahilavati. Even in his childhood, Barbarika was a very brave warrior. He learnt the art of warfare from his mother. God Shiva, pleased with him, gave him the three infallible arrows (Teen Baan). Hence, Barbarika came to be known by the appellation Teen Baan Dhaari, the “Bearer of Three Arrows”. Later, Agni (The God of Fire) gave him the bow that would make him victorious in the three worlds. When Barbarika got to know that battle between the Pandavas and the Kauravas had become inevitable, he wanted to witness what was to be the Mahābhārata War. He promised his mother that if he felt the urge to participate in the battle, he would join the side which would be losing. He rode to the field on his Blue Horse equipped with his three arrows and bow.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <img
              src="https://rukminim1.flixcart.com/image/832/832/juk4gi80/poster/z/t/z/large-newposter8315-lord-khatu-shyam-ji-i-poster-large-print-on-original-imaf5tfyahpty8gy.jpeg?q=70"
              alt="Khatu Shyam Ji"
              className="relative rounded-2xl shadow-2xl border border-white/10 w-full h-full object-cover z-10"
            />
          </motion.div>
          <motion.div 
            initial="hidden" whileInView="visible" variants={fadeInUp} viewport={{ once: true }}
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-semibold leading-tight">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-500">About Shree Shyam Parivar Foundation Bhopura</span> 
            </h1>
            <p className="text-gray-900 text-lg leading-relaxed text-justify font-light ">
Shree Shyam Parivar Foundation Bhopura is a non-profit organization established on September 4, 2021, under the Companies Act, 2013 (CIN No. U74999DL2021NPL386100). Our mission is to serve society and address key social issues through a wide range of charitable and community-driven activities. Founded by a group of committed social workers, the foundation aims to uplift underprivileged sections of society through efforts in healthcare, education, vocational training, and empowerment—particularly for women and children. We are also dedicated to promoting sustainable development within local communities. Our work focuses on supporting vulnerable groups such as migrants, impoverished and abused women, neglected children, senior citizens, and school dropouts. To reach these communities, we organize and facilitate: At Shree Shyam Parivar Foundation, we envision a society where every individual, irrespective of their socio-economic background, has access to opportunities for growth and prosperity. We value compassion, integrity, and transparency in all our efforts, striving to create an inclusive community where everyone can thrive. Through collaboration with like-minded organizations, local governments, and volunteers, we continue to work towards empowering.            </p>
      ...
      {/* 5. The Legend of Barbarika (Staggered Layout) */}
      <section className="py-24 bg-[#f8f9fa] text-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12 mb-20">
             <div className="w-full md:w-1/3">
                <img src="https://rukminim1.flixcart.com/image/832/832/juk4gi80/poster/z/t/z/large-newposter8315-lord-khatu-shyam-ji-i-poster-large-print-on-original-imaf5tfyahpty8gy.jpeg?q=70" className="w-64 h-64 mx-auto rounded-full border-8 border-white shadow-2xl object-cover" alt="Barbarika" />
             </div>
             <div className="w-full md:w-2/3">
                <h2 className="text-4xl font-bold text-red-500 mb-6">The Legend of Barbarika</h2>
                <p className="text-xl text-gray-600 leading-relaxed italic">"Bearer of Three Arrows" — The ultimate sacrifice for righteousness.</p>
                                <p className="text-xl text-gray-600 leading-relaxed italic">"Barbarika Donates His Head to Krishna."</p>

             </div>
          </div>
          <div className="columns-1 md:columns-2 gap-12 space-y-8 text-gray-700 leading-relaxed text-justify">
             <p>According to legend from the Mahabharata, Barbarika, the grandson of Bhima and son of Ghatotkach, was an incredibly powerful warrior who had vowed to support the weaker side in any battle. Possessing three infallible arrows and immense strength, he intended to participate in the Kurukshetra war. Before the battle began, Lord Krishna, disguised as a Brahmin, tested Barbarika’s intentions and realized that his vow could unintentionally support adharma (unrighteousness) by constantly switching sides. To prevent this, Krishna revealed his divine form and asked Barbarika for a supreme sacrifice. In an act of ultimate devotion and humility, Barbarika willingly donated his head (Shish) to Krishna. Moved by his selflessness, Krishna granted him a boon that in the age of Kaliyuga, he would be worshipped as Shyam, and those who remember him with a pure heart would be blessed. His head, said to have witnessed the entire war from a hilltop, is now enshrined in the sacred Khatu Shyam Temple in Rajasthan—a symbol of selfless devotion and eternal grace.</p>
             <p className="bg-red-50 p-8 rounded-2xl border-l-4 border-red-500">In an act of ultimate devotion, Barbarika willingly donated his head (Shish) to Krishna. Krishna granted him a boon that in Kaliyuga, he would be worshipped as Shyam.</p>
          </div>
        </div>
      </section>

      {/* 6. Foundation & Vision (Modern Bento Grid) */}
      <section className="py-2 bg-white text-white relative">
         <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-red-400 backdrop-blur-md p-10 rounded-3xl border border-white/20">
               <div className="flex items-center gap-4 mb-6 text-white">
                  <Eye size={40} />
                  <h3 className="text-3xl font-bold">Our Vision</h3>
               </div>
               <p className="text-white text-lg leading-relaxed text-justify">The Khatu Shyam Baba Seva Foundation is committed to uplifting socially and economically disadvantaged communities by providing quality education, healthcare, and livelihood opportunities. Our mission is to ensure that children, especially those from underprivileged backgrounds, receive the education, health support, and nutrition they need to grow into responsible citizens. We empower girls to pursue their educational and professional aspirations, helping them become confident, independent contributors to society. Through vocational training and career counseling, we equip youth with the skills needed to earn a stable income and improve their quality of life. Additionally, we provide healthcare services and wellness initiatives to ensure that marginalized communities have access to basic healthcare. By creating sustainable livelihood opportunities, we strive to break the cycle of poverty, empowering individuals to lead self-sufficient lives with dignity.</p>
            </div>
            <div className="bg-red-400 backdrop-blur-md p-10 rounded-3xl border border-white/20">
               <div className="flex items-center gap-4 mb-6 text-white">
                  <Target size={40} />
               ...
               <p className="text-white text-lg leading-relaxed text-justify">Since its foundation, the Khatu Shyam Baba Seva Foundation has been dedicated to fostering a social order based on the principles of "Hare Ka Sahara", focusing on promoting inclusive education, ensuring quality learning for all children regardless of gender, class, race, ethnicity, or religion. The Foundation is committed to early childhood development, implementing child-centered approaches, and providing teacher training to improve educational outcomes. Additionally, it strengthens community engagement by building closer relationships between schools and local communities, while also emphasizing gender equality, health and well-being, sustainable development, and the integration of technology in education. Through scholarships and financial support, the Foundation strives to eliminate educational barriers, empowering marginalized children and ensuring equal opportunities for all.</p>
            </div>
         </div>
      </section>

      {/* 7. Founders (Premium Portrait Style) */}
      <section className="py-24 bg-white text-black">
        <h2 className="text-5xl font-bold text-center text-red-500 mb-20">Founders</h2>
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 px-6">
          {[
            { name: "Ravindra Yadav", img: "/dir.png" },
            { name: "Omkar Sharma", img: "/dir2.png" }
          ].map((founder, i) => (
            <motion.div key={i}  className="group relative overflow-hidden rounded-xl shadow-2xl">
              <img src={founder.img} className="w-full h-[600px] object-cover  transition-all duration-700" alt={founder.name} />
              <div className="absolute inset-0 bg-gradient-to-t from-red-900 via-transparent to-transparent opacity-80"></div>
              <div className="absolute bottom-10 left-10">
                <p className="text-red-400 font-bold tracking-widest uppercase mb-2">Founder</p>
      ...
      {/* 8. Trust Board & Members (Clean Grid) */}
      <section className="py-24 bg-gray-50 text-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Trust Board Members</h2>
            <div className="h-1 w-20 bg-red-600 mx-auto"></div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            {boardMembers.map((person, idx) => (
              <div key={idx} className="group text-center">
                <div className="relative mb-4 overflow-hidden rounded-xl aspect-[3/4]">
                  <img src={person.src} className="w-full h-full object-cover transition-transform group-hover:scale-110" alt={person.name} />
                </div>
          ...
          <div className="mt-32">
            <h2 className="text-4xl font-bold text-center text-gray-900 mb-16 underline underline-offset-8  decoration-red-400">Our Pillars of Support</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-8">
              {members.map((member, idx) => (
                <div key={idx} className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                   <img src={member.img} className="w-16 h-16 rounded-full object-cover border-2 border-red-100" alt={member.name} />
                   <div>
                     <h4 className="font-bold text-gray-800 leading-tight">{member.name}</h4>
                     <p className="text-xs text-gray-500 uppercase tracking-tighter">Member</p>
                   </div>
                </div>
              ))}
            </div>
